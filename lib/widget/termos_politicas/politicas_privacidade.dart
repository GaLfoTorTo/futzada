          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    for (int i = 0; i < compromisso_usuario.length; i++)
                      Row(
                        children: [
                          Text(
                            i == 0 ? 'A)' : i == 1 ? 'B)' : 'C)',
              ...
              const Padding(
                padding: EdgeInsets.symmetric(vertical: 10),
                child: Text(
                  "Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site. Esta política é efetiva a partir de 17 February 2024 17:36",
                  style: TextStyle(
                    color: AppColors.gray_500,
                    fontSize: 12,
                    fontWeight: FontWeight.normal
