...
class EconomyModel {
  ...
  factory EconomyModel.fromMap(Map<String, dynamic> map) {
    return EconomyModel(
      ...
      patrimony: map['patrimony'] != null ? (map['patrimony'] as num).toDouble() : null,
      price: map['price'] != null ? (map['price'] as num).toDouble() : null,
      valuation: map['valuation'] != null ? (map['valuation'] as num).toDouble() : null,
      points: map['points'] != null ? (map['points'] as num).toDouble() : null,
      totalPoints: map['totalPoints'] != null ? (map['totalPoints'] as num).toDouble() : null,
