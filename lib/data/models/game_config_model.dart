...
class GameConfigModel {
  ...
  @override
  String toString() {
    return 'GameConfigModel(id: $id, eventId: $eventId, refereerId: $refereerId, category: $category, duration: $duration, playersPerTeam: $playersPerTeam, points: $points, config: $config, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
  }
