...
class AppHelper {
  ...
  static Future<Map<String, String>> mapSvgToString() async {
    //NOVO MAP DE SVG EM FORMATO DE STRING
    Map<String, String> svgStrings = {};
    //LOOP NOS SVGS
    for (var entry in AppIcones.emblemas.entries) {
      svgStrings[entry.key] = await AppHelper.svgToString(entry.value);
    }
