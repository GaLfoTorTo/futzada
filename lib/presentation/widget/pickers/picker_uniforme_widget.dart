...
class PickerUniformeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> lvcConfig = configEstampa['lvc']!;
    Map<String, dynamic> lvlConfig = configEstampa['lvl']!;
    Map<String, dynamic> lhcConfig = configEstampa['lhc']!;
    Map<String, dynamic> lhlConfig = configEstampa['lhl']!;
    Map<String, dynamic> mcConfig = configEstampa['mc']!;
    Map<String, dynamic> mmConfig = configEstampa['mm']!;
    Map<String, dynamic> mxlConfig = configEstampa['mxl']!;
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (lvcConfig['checked'])
                  BoxShadow(
                    color: lvcConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (lvlConfig['checked'])
                  BoxShadow(
                    color: lvlConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (lhcConfig['checked'])
                  BoxShadow(
                    color: lhcConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (lhlConfig['checked'])
                  BoxShadow(
                    color: lhlConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (mcConfig['checked'])
                  BoxShadow(
                    color: mcConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (mmConfig['checked'])
                  BoxShadow(
                    color: mmConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                if (mxlConfig['checked'])
                  BoxShadow(
                    color: mxlConfig['color'].withAlpha(50),
                    spreadRadius: 8,
                    blurRadius: 1,
                    offset: const Offset(0,0),
                  ),
